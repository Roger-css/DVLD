...
namespace DVLD.DataService.Migrations
{
    ...
    [Migration("20240731153342_fixed DetainLicenses view")]
    partial class fixedDetainLicensesview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DVLD.Entities.Views.DetainedLicensesView", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToView("DetainedLicense_View", (string)null);
                });
            ...
            modelBuilder.Entity("DVLD.Entities.DbSets.InternationalDrivingLicense", b =>
                {
                    ...
                    b.HasOne("DVLD.Entities.DbSets.Driver", "Driver")
                        .WithMany("InternationalDrivingLicense")
